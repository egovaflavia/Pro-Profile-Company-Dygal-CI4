                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Product" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="namaProduct">Deskripsi</label>
                                        <textarea name="desc" id="textarea" class="textarea"></textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="harga" name="harga" placeholder="Harga Boleh di Kosongkang">
                                    </div>
                                    <div class="form-group">
                                        <label for="namaProduct">Spesifikasi</label>
                                        <textarea name="spec" id="textarea" class="textarea"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
