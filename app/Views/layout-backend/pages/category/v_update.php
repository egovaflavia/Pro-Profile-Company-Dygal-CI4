            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Update Data <?= $title; ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?= $categorys->category_nama ?>" type="text" class="form-control" id="namaCategory" name="namaCategory" placeholder="Nama Category" required>
                                    </div>
                                </div>
                            </div>
                        </div>
